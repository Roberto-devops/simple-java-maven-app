pipeline {
  ...
  stages {
    ...
    stage('Sonar') {
      steps {
        sh 'mvn sonar:sonar -Dsonar.projectKey=test -Dsonar.host.url=http://192.168.10.20:8080 -Dsonar.login=fc1ad35ec36960396cb0ba7a20ef6c209cc5f2fd  -Dsonar.tests=target/surefire-reports/*.xml'
      }
    }
